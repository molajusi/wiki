...
*최초 작성일시: 2026-08-24 오후 12:35:00 (KST, UTC+9) | 최종 수정일시: 2026-09-04 오후 02:54:30 (KST, UTC+9)*
...
2. **역추적(Backtracking)의 동력:** 열리지 않는 문이나 도달할 수 없는 높이를 시각적으로 각인(자이가르닉 효과, Zeigarnik Effect)시켜, 향후 해제 기제를 획득했을 때 능동적으로 과거 영역을 재방문하게 만드는 구조적 유인.
